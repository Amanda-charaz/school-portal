...
const styles = {
  ...
  badge: { padding: "4px 8px", color: "white", borderRadius: "4px", fontSize: "0.75rem", fontWeight: "bold", textTransform: "uppercase" },
  ...
  subjectHeading: { display: "flex", alignItems: "center", gap: "6px", fontSize: "0.75rem", fontWeight: "700", color: "#1e3a8a", marginBottom: "12px" },
  gridContainer: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" },
  checkboxLabel: { display: "flex", alignItems: "center", gap: "8px", fontSize: "0.75rem", color: "#475569", cursor: "pointer" },
  checkbox: { width: "16px", height: "16px", cursor: "pointer" },
  infoBanner: { display: "flex", gap: "10px", alignItems: "flex-start", padding: "12px", backgroundColor: "#eff6ff", borderRadius: "6px", fontSize: "0.75rem", color: "#1e40af", lineHeight: "1.5" },
