    ...
    <div className="w-full max-w-5xl mx-auto p-4 sm:p-6 space-y-6 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700/60 shadow-sm flex flex-col justify-between animate-float">
          <div>
            ...
            <div className="text-4xl sm:text-5xl font-black text-emerald-600 dark:text-emerald-400 mb-6">
          ...
          <div className="grid grid-cols-3 gap-2 pt-4 border-t border-gray-100 dark:border-gray-700/60">
            <div className="text-center">
              ...
              <div className="text-xxs uppercase tracking-wide text-gray-400 font-bold mt-1">Present</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-black text-amber-600 dark:text-amber-400">
                {data.attendance_stats?.summary?.late_days ?? 0}
              </div>
              <div className="text-xxs uppercase tracking-wide text-gray-400 font-bold mt-1">Late</div>
            </div>
            <div className="text-center">
              <div className="text-lg font-black text-red-500 dark:text-red-400">
                {data.attendance_stats?.summary?.absent_days ?? 0}
              </div>
              <div className="text-xxs uppercase tracking-wide text-gray-400 font-bold mt-1">Absent</div>
            </div>
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700/60 shadow-sm animate-float">
          <div className="text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-4 flex items-center justify-between">
              ...
              academic_summary.slice(0, 3).map((res, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <div className="w-8 h-8 rounded-lg bg-school-blue text-white font-black text-xs flex items-center justify-center shadow-sm">
                      {res.grade_letter}
                    </div>
                  </div>
                </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700/60 shadow-sm flex items-center gap-3 animate-float">
          ...
          <div className="min-w-0">
            <div className="text-xxs font-bold text-gray-400 uppercase tracking-wider">Student ID</div>
            <div className="text-sm font-black text-gray-900 dark:text-white truncate">{profile.school_id}</div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700/60 shadow-sm flex items-center gap-3 animate-float">
          ...
          <div className="min-w-0">
            <div className="text-xxs font-bold text-gray-400 uppercase tracking-wider">Current Stream</div>
            <div className="text-sm font-black text-gray-900 dark:text-white truncate">{profile.assigned_class || "Unallocated"}</div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700/60 shadow-sm flex items-center gap-3 animate-float">
          ...
          <div className="min-w-0">
            <div className="text-xxs font-bold text-gray-400 uppercase tracking-wider">Fees Balance</div>
