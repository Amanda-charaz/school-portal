    ...
    <div style={styles.container}>
      ...
      <main style={styles.content}>
        <header style={styles.header}>
          ...
          <p className="text-sm" style={{ color: "#64748b" }}>Welcome back, {userInfo.full_name}</p>
        </header>
        ...
        <section className="mb-8">
          ...
          <div style={styles.grid}>
            {error ? (
              ...
              <p className="text-sm" style={{ color: "#64748b" }}>No results found for your account.</p>
            )}
          </div>
        </section>
...
const styles = {
  ...
  logo: { fontSize: "1.5rem", fontWeight: "bold", marginBottom: "20px", color: "#6366f1" },
  roleIndicator: { display: "flex", alignItems: "center", gap: "8px", fontSize: "0.75rem", fontWeight: "600", color: "#a5f3fc", marginBottom: "20px", padding: "8px", backgroundColor: "#0c4a6e", borderRadius: "6px" },
  ...
  subjectText: { margin: 0, color: "#1e293b", fontWeight: "600" },
  gradeBadge: { backgroundColor: "#e0e7ff", color: "#4338ca", padding: "4px 10px", borderRadius: "20px", fontSize: "0.75rem", fontWeight: "bold" },
  cardBody: { color: "#4b5563", marginBottom: "15px" },
